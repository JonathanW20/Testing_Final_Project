...
such as weak Nullstellensatz, where the GB of the ideals and vanishing polynomials is 1 (GB($J$ + $J_{0}$) = 1). Another form of verification is checking if the Gröbner Basis of 
...
\begin{itemize}
    ...
    \item Henry: Created Python script, assisted in writing the report, converted Singular files
