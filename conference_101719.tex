...
\title{Verification of Integer Multiplier Circuits\\}
...
The paper presents the testing and verification of a 2-bit, 4-bit, and 32-bit integer multiplier circuit. We designed a 2-bit multiplier from scratch and derived polynomial spec for it.
